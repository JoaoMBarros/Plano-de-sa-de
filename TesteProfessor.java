...
public class TesteProfessor {
    ...
    public static String removeTudoProcedimentoBanco = "DELETE FROM procedimento WHERE codigo < 1000;";
    public static String removeTudoBeneficiarioBanco = "DELETE FROM beneficiario WHERE cpf < 1000;";
    public static String removeTudoHistoricoBanco = "DELETE FROM historico WHERE beneficiario < 1000;";

    @Test
    public void testarCadastroDeBeneficiarioCorreto() throws BeneficiarioExistenteException, IdadeInvalidaException, DadosInvalidosException, BeneficiarioInexistenteException, SQLException {
        Connection conexao = Conexao.getConexao();
        Statement st = conexao.createStatement();
        st.executeUpdate(removeTudoProcedimentoBanco);
        st.executeUpdate(removeTudoBeneficiarioBanco);
        st.executeUpdate(removeTudoHistoricoBanco);
    ...
    @Test
    public void testarCadastroDeBeneficiarioJaCadastrado() throws BeneficiarioExistenteException, IdadeInvalidaException, DadosInvalidosException, SQLException {
        Connection conexao = Conexao.getConexao();
        Statement st = conexao.createStatement();
        st.executeUpdate(removeTudoProcedimentoBanco);
        st.executeUpdate(removeTudoBeneficiarioBanco);
    ...
    @Test
    public void testarCadastroDeBeneficiarioComIdadeInvalida() throws BeneficiarioExistenteException, IdadeInvalidaException, SQLException {
        Connection conexao = Conexao.getConexao();
        Statement st = conexao.createStatement();
        st.executeUpdate(removeTudoProcedimentoBanco);
        st.executeUpdate(removeTudoBeneficiarioBanco);
    ...
    @Test
    public void testarCadastroDeBeneficiarioComDadosInvalidos() throws BeneficiarioExistenteException, IdadeInvalidaException, SQLException {
        Connection conexao = Conexao.getConexao();
        Statement st = conexao.createStatement();
        st.executeUpdate(removeTudoProcedimentoBanco);
        st.executeUpdate(removeTudoBeneficiarioBanco);
    ...
    @Test
    public void testarCadastroDeExameOk() throws DadosInvalidosException, ProcedimentoInexistenteException, SQLException {
        Connection conexao = Conexao.getConexao();
        Statement st = conexao.createStatement();
        st.executeUpdate(removeTudoProcedimentoBanco);
        st.executeUpdate(removeTudoBeneficiarioBanco);
    ...
    @Test
    public void testarCadastroDeExameComDadosInvalidos() throws DadosInvalidosException, SQLException {
        Connection conexao = Conexao.getConexao();
        Statement st = conexao.createStatement();
        st.executeUpdate(removeTudoProcedimentoBanco);
        st.executeUpdate(removeTudoBeneficiarioBanco);
    ...
    @Test
    public void testarCadastroDeCirurgiaOk() throws DadosInvalidosException, ProcedimentoInexistenteException, SQLException {
        Connection conexao = Conexao.getConexao();
        Statement st = conexao.createStatement();
        st.executeUpdate(removeTudoProcedimentoBanco);
        st.executeUpdate(removeTudoBeneficiarioBanco);
    ...
    @Test
    public void testarCadastroDeCirurgiaComDadosInvalidos() throws DadosInvalidosException, SQLException {
        Connection conexao = Conexao.getConexao();
        Statement st = conexao.createStatement();
        st.executeUpdate(removeTudoProcedimentoBanco);
        st.executeUpdate(removeTudoBeneficiarioBanco);
    ...
    @Test
    public void testarSolicitarCirurgiaComErro() throws DadosInvalidosException, BeneficiarioExistenteException, IdadeInvalidaException, GeneroInvalidoException, CarenciaException, PeriodicidadeException, UnicidadeException, BeneficiarioInexistenteException, ProcedimentoInexistenteException, SQLException {
        Connection conexao = Conexao.getConexao();
        Statement st = conexao.createStatement();
        st.executeUpdate(removeTudoProcedimentoBanco);
        st.executeUpdate(removeTudoBeneficiarioBanco);
    ...
    @Test
    public void testarSolicitarExameComErro() throws DadosInvalidosException, BeneficiarioExistenteException, IdadeInvalidaException, GeneroInvalidoException, CarenciaException, PeriodicidadeException, UnicidadeException, BeneficiarioInexistenteException, ProcedimentoInexistenteException, SQLException {
        Connection conexao = Conexao.getConexao();
        Statement st = conexao.createStatement();
        st.executeUpdate(removeTudoProcedimentoBanco);
        st.executeUpdate(removeTudoBeneficiarioBanco);
    ...
    @Test
    public void testarFaturamento() throws DadosInvalidosException, BeneficiarioExistenteException, IdadeInvalidaException, GeneroInvalidoException, CarenciaException, PeriodicidadeException, UnicidadeException, BeneficiarioInexistenteException, ProcedimentoInexistenteException, SQLException {
        Connection conexao = Conexao.getConexao();
        Statement st = conexao.createStatement();
        st.executeUpdate(removeTudoProcedimentoBanco);
        st.executeUpdate(removeTudoBeneficiarioBanco);
